...
def run_ranges_test(ranges, expected_tagmap, expected_axislist):
...
def test_basic():
    ...
    run_ranges_test(ranges, tagmap, [(0, 20), (-100, 100)])
...
def test_sparse():
    ...
    run_ranges_test(ranges, tagmap, [(-6, 28), (-37, 139), (-177, 673), (-1678, 1816), (-12611, 45266)])
...
def test_labelled():
    ...
    run_ranges_test(ranges, tagmap, [(1512, 8021)])
